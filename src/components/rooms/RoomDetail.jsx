              ...
              <div>
                ...
                <div className="mt-4 space-y-3">
                  ...
                  <div className="flex items-center">
                    ...
                    <span className="text-gray-700">${room.pricePerNight}/night</span>
                  </div>
                </div>
                
                <div className="mt-6">
                  <h4 className="text-sm font-medium text-gray-900">Bed Configuration</h4>
              ...
              <div>
                ...
                <div className="mt-6">
                  ...
                  <p className="mt-2 text-gray-700">
                    This {room.type.toLowerCase()} room offers comfortable accommodations for up to {room.capacity} guests.
